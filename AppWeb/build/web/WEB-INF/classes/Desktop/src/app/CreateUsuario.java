    ...
    private void txtcorreoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtcorreoFocusLost
       Comprobacion com = new Comprobacion();
        if(com.validarCorreo(txtcorreo.getText())){
            ...
            JOptionPane.showMessageDialog(null, "Email incorrecto", "Corriga Email", JOptionPane.INFORMATION_MESSAGE);
...
//           if (txtNombre.toString().length()==1)
