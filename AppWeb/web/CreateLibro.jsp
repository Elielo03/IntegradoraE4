...
<html>
  ...
  <h1>Crear Libro</h1>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="txtNombre" name="txtTitulo" type="text" placeholder="Titulo" class="form-control input-md" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="txtApe1" name="txtISBN" type="text" placeholder="ISBN" class="form-control input-md" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="txtApe2" name="txtPaginas" type="number" min="1" max="10000" placeholder="Número de Páginas" class="form-control input-md">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select class="selectpicker show-tick" name="cmbArea" requiered="">
                            <c:forEach items="${attArea}" var="elem">

                                <option> <c:out value="${elem.nombre}" /> </option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select class="selectpicker show-tick" name="cmbEditorial" requiered="">
